...
| `reforger-wiki-scripting-conf` | `UserConfig`, `ResourceName approach`, `SCR_ConfigHelperT` |
...
| `reforger-wiki-serialisation` | `SCR_JsonSaveContext`, `SerializationSave`, `WriteValue` |
...
| `reforger-wiki-damage-effects` | `SCR_DamageEffectComponent`, damage particles, damage sounds |
...
| `reforger-wiki-temporary-feature` | `SCR_TemporaryFeature`, feature flag, temporary override |
